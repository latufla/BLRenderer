...
glm::vec3 GrEngineConnector::calcTimeInterpolation(uint32_t time, std::vector<Vec3Key> vecs) {
...
glm::mat4 GrEngineConnector::calcTimeInterpolation(uint32_t time, std::vector<Mat4Key> mats) {
